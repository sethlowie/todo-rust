...
var author$project$Main$decodeTodo = A3(
...
var author$project$Main$getTodos = elm$http$Http$get(
	{
		expect: A2(elm$http$Http$expectJson, author$project$Main$GotTodos, author$project$Main$decodeTodos),
...
_Platform_export({'Main':{'init':author$project$Main$main(elm$json$Json$Decode$string)({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{"Main.Todo":{"args":[],"type":"{ title : String.String, description : String.String }"}},"unions":{"Main.Msg":{"args":[],"tags":{"NoOp":[],"GotTodos":["Result.Result Http.Error (List.List Main.Todo)"]}},"List.List":{"args":["a"],"tags":{}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}}}}})}});}(this));